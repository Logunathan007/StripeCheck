...
@Component({
  selector: 'app-trust-service-provider',
  templateUrl: './trust-service-provider.component.html'
})
export class TrustServiceProviderComponent implements OnInit{
  ...
  payToSP(){
    this.service.payToServiceProvider(this.amount,this.selectedAccount).subscribe(
      (obj:any)=>{
